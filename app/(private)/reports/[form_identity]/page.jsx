                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <option value="question-specific">Question-Specific Report</option>
                        </select>
                    </div>
                </div>
                 <div className="space-y-2">
            ...
            <div className="grid gap-6 md:grid-cols-2">
                <Card>
                    ...
                    <CardContent>
                        <Table>
                             ...
                             <TableBody>
                                <TableRow>
                                    <TableCell className="font-medium">Total Submissions</TableCell>
                                    <TableCell className="text-right">{summaryReport.totalSubmissions}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell className="font-medium">Average Rating</TableCell>
                                    <TableCell className="text-right">{summaryReport.averageRating.toFixed(1)}</TableCell>
                                </TableRow>
                                 <TableRow>
                                    <TableCell className="font-medium">Yes Percentage</TableCell>
                                    <TableCell className="text-right">{summaryReport.yesPercentage.toFixed(1)}%</TableCell>
                                </TableRow>
                                 <TableRow>
                                    <TableCell className="font-medium">No Percentage</TableCell>
                                    <TableCell className="text-right">{summaryReport.noPercentage.toFixed(1)}%</TableCell>
                                </TableRow>
                                 <TableRow>
                                    <TableCell className="font-medium">Rating Responses</TableCell>
                                    <TableCell className="text-right">{summaryReport.ratingCount}</TableCell>
                                </TableRow>
                                 <TableRow>
                                    <TableCell className="font-medium">Yes/No Responses</TableCell>
                                    <TableCell className="text-right">{summaryReport.yesNoCount}</TableCell>
                                </TableRow>
                             </TableBody>
                        </Table>
                    </CardContent>
                ...
                <Card>
                     <CardHeader className="flex flex-row items-center justify-between">
                         ...
                         <Button size="icon" variant="ghost" onClick={() => downloadGraphAsPng(summaryPieChartRef, 'summary_yes_no_distribution')}>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                ...
                                {summaryReport.texts.length === 0 && (
                                     <TableRow>
                                        <TableCell className="text-muted-foreground text-center">No comments found</TableCell>
                                    </TableRow>
                                )}
                            </TableBody>
                        </Table>
                         {summaryReport.texts.length > 10 && (
                            <div className="flex items-center justify-end space-x-2 py-4">
                                ...
                                size="sm"
                                onClick={() => setSummaryTextPage(summaryTextPage + 1)}
                                disabled={summaryTextPage * 10 >= summaryReport.texts.length}
                                >
                                Next
                                </Button>
                            </div>
          ...
          <div className="space-y-8">
               {!selectedQuestion && defaultQuestionReport && (
                   <div className="space-y-6">
                       <h3 className="text-2xl font-bold tracking-tight">Overview by Question</h3>
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                            {Object.entries(defaultQuestionReport).map(([id, stats], index) => {
                                const question = feedbackForm.questions.find((q) => q.identity === id);
                                if (!question) return null;
                                ...
                                const textResponses = stats.type === "TEXT" ? stats.texts.slice(0, 10) : [];
                                
                                return (
                                    <Card key={id} className="w-full">
                                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                            <CardTitle className="text-lg font-semibold">{question.text}</CardTitle>
                                             {(stats.type === "YES_NO" || stats.type === "RATING") && (
                                                 <Button 
                                                    size="icon" 
                                                    variant="ghost" 
                                                    onClick={() => {
                                                         ...
                                                         if (el) {
                                                              html2canvas(el, { useCORS: true, scale: 2, backgroundColor: "#ffffff" })
                                                              .then(canvas => {
                                                                 const link = document.createElement('a');
                                        ...
                                        <CardContent>
                                            {stats.type === "RATING" && (
                                                <div className="space-y-4">
                                                    ...
                                                    <div className="h-[250px]" id={`chart-container-${id}`}>
                                                        <ResponsiveContainer width="100%" height="100%">
                                                            <LineChart data={ratingData}>
                                                                ...
                                                                <YAxis />
                                                                <Tooltip />
                                                                <Line type="monotone" dataKey="count" stroke="#3490dc" strokeWidth={2} />
                                                            </LineChart>
                                                        </ResponsiveContainer>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div className="w-full md:w-1/3 space-y-4">
                                                         <div className="p-4 bg-muted/50 rounded-lg space-y-2">
                                                            <div className="flex justify-between">
                                                                ...
                                                                <span className="font-bold">{stats.yesPercentage.toFixed(1)}%</span>
                                                            </div>
                                                             <div className="flex justify-between">
                                                                <span className="text-sm font-medium">No</span>
                                                                <span className="font-bold">{stats.noPercentage.toFixed(1)}%</span>
                                                            </div>
                                                         </div>
                                                    </div>
                                                    <div className="w-full md:w-2/3 h-[250px]" id={`chart-container-${id}`}>
                                                         <ResponsiveContainer width="100%" height="100%">
                                                            <BarChart
                                                                data={[
                                                            ...
                                                            >
                                                                ...
                                                                <YAxis />
                                                                <Tooltip />
                                                                <Bar dataKey="value" fill="#3490dc" radius={[4, 4, 0, 0]} />
                                                            </BarChart>
                                                        </ResponsiveContainer>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div className="space-y-2">
                                                    <Table>
                                                        ...
                                                        <TableBody>
                                                            ...
                                                            {textResponses.length === 0 && (
                                                                <TableRow>
                                                                    <TableCell className="text-muted-foreground text-center">No comments</TableCell>
                                                                </TableRow>
                                                            )}
                                                        </TableBody>
                                                    </Table>
                                                    {stats.texts.length > 10 && (
                                                         <div className="flex items-center justify-end space-x-2 pt-2">
                                                            <Button size="sm" variant="outline" onClick={() => setAllQuestionsPage(allQuestionsPage - 1)} disabled={allQuestionsPage === 1}>Prev</Button>
                                                            <span className="text-xs">Page {allQuestionsPage}</span>
                                                            <Button size="sm" variant="outline" onClick={() => setAllQuestionsPage(allQuestionsPage + 1)} disabled={allQuestionsPage * 10 >= stats.texts.length}>Next</Button>
                                                        </div>
                                                    )}
                                                 </div>
                                             )}
               ...
               {selectedQuestion && questionReport && (
                   <div className="space-y-6">
                        <h3 className="text-2xl font-bold tracking-tight">
                            Report for: {feedbackForm.questions.find((q) => q.identity === selectedQuestion)?.text}
                        </h3>
                        
                        <div className="grid gap-6 md:grid-cols-2">
                             {(questionReport.yesPercentage !== undefined || questionReport.averageRating !== undefined) && (
                                <Card>
                                    <CardHeader>
                                         ...
                                         <Table>
                                            <TableBody>
                                                {questionReport.averageRating !== undefined && (
                                                     <TableRow>
                                                        <TableCell className="font-medium">Average Rating</TableCell>
                                                        <TableCell className="text-right">{questionReport.averageRating.toFixed(1)}</TableCell>
                                                    </TableRow>
                                                )}
                                                {questionReport.yesPercentage !== undefined && (
                                                     <TableRow>
                                                        <TableCell className="font-medium">Yes Percentage</TableCell>
                                                        <TableCell className="text-right">{questionReport.yesPercentage.toFixed(1)}%</TableCell>
                                                    </TableRow>
                                                )}
                                            </TableBody>
                                         </Table>
                                  ...
                                  <Card>
                                     <CardHeader className="flex flex-row items-center justify-between">
                                        <CardTitle>Distribution Chart</CardTitle>
                                         <Button size="icon" variant="ghost" onClick={() => downloadGraphAsPng(pieChartRef, 'question_distribution')}>
                                            <Download className="h-4 w-4" />
                                        </Button>
                                     </CardHeader>
                                     <CardContent>
                                         <div className="h-[300px]" ref={pieChartRef}>
                                             <ResponsiveContainer width="100%" height="100%">
                                                <PieChart>
                                                    <Pie
                                                        data={[
                                                            { name: "Yes", value: questionReport.yesPercentage },
                                                            { name: "No", value: 100 - questionReport.yesPercentage },
                                                        ]}
                                                        dataKey="value"
                                                        nameKey="name"
                                                        cx="50%"
                                  ...
                                  <Card className="col-span-full">
                                      <CardHeader className="flex flex-row items-center justify-between">
                                        <CardTitle>Rating Distribution</CardTitle>
                                          <Button size="icon" variant="ghost" onClick={() => downloadGraphAsPng(barChartRef, 'rating_distribution')}>
                                            <Download className="h-4 w-4" />
                                        </Button>
                                      </CardHeader>
                                      <CardContent>
                             ...
                             <Card>
                                 ...
                                 <CardContent>
                                     <Table>
                                        ...
                                        <TableBody>
                                             {questionReport.texts
                                                .slice((specificTextPage - 1) * 10, specificTextPage * 10)
                                                .map((text, index) => (
                                                    <TableRow key={index}>
                                                        <TableCell>{text}</TableCell>
                                                    </TableRow>
                                      ...
                                      {questionReport.texts.length > 10 && (
                                            <div className="flex items-center justify-end space-x-2 py-4">
                                                ...
                                                variant="outline"
                                                size="sm"
                                                onClick={() => setSpecificTextPage(specificTextPage - 1)}
                                                ...
                                                size="sm"
                                                onClick={() => setSpecificTextPage(specificTextPage + 1)}
                                                disabled={specificTextPage * 10 >= questionReport.texts.length}
                                                >
                                                Next
                                                </Button>
                                            </div>
